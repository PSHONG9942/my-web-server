...
const radicalsData = [
    ...
    { name: '虫字旁', radical: '虫', characters: ['蚊', '蚁', '虾', '蛇', '蜂', '蝶', '蛛', '蜻', '蜓', '蚂', '蛙', '蛹', '萤', '蝉', '螺', '蝙', '蝠'] },
    { name: '走之旁', radical: '辶', characters: ['过', '还', '边', '近', '远', '进', '退', '送', '迎', '追', '逃', '遍', '道', '遇', '达', '迟', '辽', '速'] },
    { name: '竹字头', radical: '⺮', characters: ['笔', '笑', '第', '答', '简', '篮', '算', '管', '箱', '箭', '筷', '篇', '符', '笨', '笛', '笼', '笠', '等'] },
    { name: '宝盖头', radical: '宀', characters: ['家', '宇', '宙', '客', '室', '宝', '守', '安', '定', '宽', '寒', '宿', '窗', '突', '灾', '实', '密', '宁'] },
    { name: '门字框', radical: '门', characters: ['问', '间', '闪', '闭', '闻', '阔', '阅', '闷', '闲', '闹', '闯', '阁', '闺', '闸', '阀'] },
    { name: '火字旁/四点底', radical: '火/灬', characters: ['烤', '炒', '烧', '烟', '炮', '灯', '灶', '灾', '灵', '炎', '炉', '烦', '热', '烈', '煮', '熟', '照', '熊'] },
    { name: '足字旁', radical: '足/⻊', characters: ['跑', '跳', '踢', '跨', '踏', '跃', '趴', '踩', '蹲', '跌', '踪', '蹦', '趾', '跟', '蹈', '距', '路'] },
    { name: '绞丝旁', radical: '纟', characters: ['红', '绿', '细', '线', '结', '纺', '织', '绘', '练', '统', '经', '纬', '级', '纯', '纸', '绝', '继', '续'] },
    { name: '食字旁', radical: '饣', characters: ['饭', '饮', '饿', '饱', '饼', '馆', '饺', '馒', '饰', '饲', '饵', '饶', '馋', '馅', '馈'] },
    { name: '金字旁', radical: '钅', characters: ['铁', '钢', '铜', '银', '钱', '钟', '针', '钉', '钓', '错', '镜', '锅', '钻', '锋', '销', '铺', '镇', '铃'] }
];
